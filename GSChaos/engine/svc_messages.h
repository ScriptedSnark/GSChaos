...
#ifdef COF_BUILD
#define MAX_MODELS 768 // don't give them GoldSrc engine anymore please
#else
...
#ifdef COF_BUILD
#define MAX_SOUNDS 768 // don't give them GoldSrc engine anymore please, SERIOUSLY
#else
...
#ifdef COF_BUILD
#define MAX_GENERIC 768 // PLEASE DON'T
#else
...
#ifdef COF_BUILD
	byte cof_unknown[8]; // IT CAN'T BE RIGHT BUT AT LEAST DYNAMIC PRECACHE WORKS FOR NOW - ScriptedSnark
#endif
	int delta_sequence;
	int playernum;
